...
void Individual::evaluateCompleteCost()
{
    ...
    for (int r = 0; r < params->nbVehicles; r++)
    {
        if (!chromR[r].empty())
        {
            ...
            // Get the distance, load, serviceDuration and time associated with the vehicle traveling
            // from the depot to the first client Assume depot has service time 0 and earliestArrival 0
