...
// This class is used because a flat vector is faster than a vector of vectors which requires two
// lookup operations rather than one to index a matrix element
class Matrix
{
...
public:
    ...
    // Constructor: create a matrix of size dimension by dimension, using a C++ vector of size
    // dimension * dimension
